...
static const char * const nl80211_cmd_table[__NL80211_CMD_AFTER_LAST] = {
        ...
        [NL80211_CMD_cured_REMAIN_ON_CHANNEL] = "cured_remain_on_channel",
        ...
        [NL80211_CMD_FRAME_WAIT_cured] = "frame_wait_cured",
        ...
        [NL80211_CMD_TDLS_cured_CHANNEL_SWITCH] = "tdls_cured_channel_switch",
